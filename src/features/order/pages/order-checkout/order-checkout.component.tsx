...
export default function OrderCheckoutComponent(): JSX.Element {
  const { formFields, hasOrderItems, paymentMethodRadio, isLoading, onSubmit } =
    useOrderForm();
        ...
        <div className="grid-container u-display-grid u-gap-30">
          ...
          >
            ...
            <fieldset
              className={classNames({
                ...
                [orderListStyles['c-order-list__container--max-height-medium']]:
                  true,
                [orderListStyles[
                  'c-order-list__container--min-inline-initial'
                ]]: true,
                [orderCheckoutStyles['l-order-checkout__group--full-width']]:
                  true,
              })}
            >
              ...
              <OrderListComponent />
              {!hasOrderItems && (
                <p className="s2 u-text-danger">
                  Mínimo de 1 item no pedido é obrigatório.
                </p>
              )}
            </fieldset>
            ...
            <fieldset
              className={orderCheckoutStyles['l-order-checkout__group']}
            >
